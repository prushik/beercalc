...
int main(int argc, char **argv)
{
	...
	write(1, str(
		...
		"<br><br>\n"
		"features:<br>\n"
		" - written in C (server) and Javascript (web client).<br>\n"
		" - open source.<br>\n"
		" - no dependency on webkit.<br>\n"
		" - full database of malts, hops, yeasts, and styles (styles derived from BJCP 2008/2015 data).<br>\n"
		" - \"auto-style\" - automatically suggest best fitting styles by recipe.<br>\n"
		" - unique polynomial-curve-based SRM-to-RGB estimation.<br>\n"
		"<br><br>\n"
